    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ route('sarech_reports') }}" method="POST" role="search" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="type"
                                required>
                                <option value="حدد نوع الفواتير" @if (!isset($type)) selected @endif>
                                    حدد نوع الفواتير
                                </option>

                                <option value="1" @if (isset($type) && $type == 1) selected @endif>الفواتير
                                    المدفوعة</option>
                                <option value="2" @if (isset($type) && $type == 2) selected @endif>الفواتير الغير
                                    مدفوعة</option>
                                <option value="3" @if (isset($type) && $type == 3) selected @endif>الفواتير
                                    المدفوعة جزئيا</option>
                                <option value="4" @if (isset($type) && $type == 3) selected @endif>الكل
                                     </option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                            ...
                            <input type="text" class="form-control" id="invoice_number" name="invoice_number"
                                value="@if (isset($invoice_num)) {{ $invoice_num }} @endif">
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('details', [$invoice->id]) }}">{{ $invoice->section->name }}</a>
                                        </td>
