                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_num"
                                    value="{{ $invoice->invoice_num }}" title="يرجي ادخال رقم الفاتورة" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="category" name="category" class="form-control">
                                    <option selected value="{{ $invoice->category }}">
                                        {{ $invoice->category }} </option>
                                </select>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">مبلغ التحصيل</label>
                                <input type="text" class="form-control" value="{{ $invoice->Amount_collection }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    ...
                                    <option {{ $invoice->Rate_VAT === '10%' ? 'selected' : '' }} value="10%">10%
                                    </option>
                                </select>
                            </div>
